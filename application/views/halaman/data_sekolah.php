                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <!-- <a href="<?php echo base_url() . "/halaman/edit_sekolah/" . $dt['id']; ?>" class="btn bg-blue waves-effect"><i class="material-icons">edit</i></a> -->
                                                <a href="javascript:;" data-id="<?php echo $dt['id'] ?>" data-npsn="<?php echo $dt['npsn'] ?>" data-namasekolah="<?php echo $dt['nama_sekolah'] ?>" data-pd="<?php echo $dt['pd'] ?>" data-rombel="<?php echo $dt['rombel'] ?>" data-rkelas="<?php echo $dt['r_kelas'] ?>" data-guru="<?php echo $dt['guru'] ?>" data-pegawai="<?php echo $dt['pegawai'] ?>" data-toggle="modal" data-target="#edit-data" class="btn bg-cyan btn-xs waves-effect" data-toggle="modal"><i class="material-icons">edit</i></a>
                                                <a class="hapus-link" href="<?php echo base_url() . "/halaman/hapussekolah/" . $dt['id']; ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo base_url('/halaman/tambahsekolah') ?>" method="post" enctype="multipart/form-data" role="form">
                            <div class="row clearfix">
        ...
        <div class="modal fade" id="edit-data" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo base_url('/halaman/dieditsekolah') ?>" method="post" enctype="multipart/form-data" role="form">
                            <div class="row clearfix">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 form-control-label">
                                    <label for="npsn">NPSN</label>
                                </div>
