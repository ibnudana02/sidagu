                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end" id="navbarSupportedContent">
                            <ul class="navbar-nav align-items-center">
                                <li class="nav-item active">
                                    <a class="nav-link" href="<?php echo base_url(); ?>umum/umum">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo base_url(); ?>umum/profil">Profil</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo base_url(); ?>umum/peta">Peta</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo base_url(); ?>umum/kontak">Kontak</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
        ...
        <div class="container">
            <div class="row align-items-sm-center align-items-lg-stretch">
                <div class="col-md-7 col-lg-7">
                    <div class="">
                        <img src="<?php echo base_url(); ?>assets/images/logo-HD.png" alt="">
                    </div>
                </div>
                <div class="col-md-5 col-lg-5">
                    <div class="learning_member_text">
                        <h5>Profil</h5>
                        <h3>Visi</h3>
                        <p>“TERWUJUDNYA DINAS PENDIDIKAN SEBAGAI PUSAT PELAYANAN PENDIDIKAN YANG BERKUALITAS, MADANI DAN MENJADI RUJUKAN NASIONAL”</p>
                        <h3>Misi</h3>
                        <ul>
                            <li></span>MEWUJUDKAN PELAYANAN PRIMA DI LINGKUNGAN INTERNAL MAUPUN EKSTERNAL ORGANISASI</li>
                            <li></span>MEWUJUDKAN AKSES PENDIDIKAN YANG MERATA DAN BERMUTU DISEMUA JENJANG DAN JENIS PENDIDIKAN</li>
                            <li></span>MEWUJUDKAN MUTU, RELEVANSI DAN DAYA SAING PENDIDIKAN.</li>
                        </ul>
                    </div>
                </div>
            </div>
