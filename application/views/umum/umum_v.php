            ...
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <div class="section_tittle text-center">
                        ...
                        <h2>Sistem Informasi Sebaran Tenaga Guru</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between">
                <div class="col-xl-3 col-sm-6 col-md-4">
                    <div class="single-footer-widget footer_2">
                        <h4>Kantor Pemerintah</h4>
                        <div class="contact_info">
                            <p><span> Alamat :</span> Jl. Pattimura No.40A, Sail, Kec. Bukit Raya, Kota Pekanbaru, Riau 28126 </p>
                            <p><span> Telepon :</span> (0761) 42788</p>
                            <p><span> Jam Buka :</span> Buka Pukul 07.00 Tutup Pukul 16.30</p>
